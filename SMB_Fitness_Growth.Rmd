...
```{r}
Ho_per_loc <- genetic_diversity(smbfit_msat_data, stratum = "sample_id", mode = c("Ho")) # calculate observed heterozygosity 
...
ggplot(smbfit_data_het_age2, aes(x = Ho, y = tl_alive)) + 
  geom_point() +
