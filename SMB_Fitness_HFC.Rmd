...
ggplot(global_het_fitness, aes(x=het, y=relW, color = hyb_status)) + 
  geom_point() +
  geom_smooth(method = "lm")

ggplot(elk_het_fitness, aes(x=het, y=relW, color = hyb_status)) + 
  geom_point() +
  geom_smooth(method = "lm")

ggplot(bsug_het_fitness, aes(x=het, y=relW, color = hyb_status)) + 
  geom_point() +
  geom_smooth(method = "lm")
