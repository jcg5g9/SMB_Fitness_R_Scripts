...
summary(lme(prop_nor_no_hsyc ~ dist_from_df, random = ~1|sex, data = smbfit_data_bsug))
#p = 0.367

summary(lme(prop_nor_no_hsyc ~ dist_from_hw, random = ~1|sex, data = smbfit_data_elk))
#p = 0.445

summary(lme(prop_nor_no_hsyc ~ river, random = ~1|sex, data = smbfit_data_gen_plot))
#p = 0.526
```
